...
import SignupModal from './SignupModal'; // You need to create this component
...
const Navbar = () => {
  ...
  useEffect(() => {
    if (showMobileMenu || showSignupModal) {
  ...
  }, [showMobileMenu, showSignupModal]);
  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10">
      ...
      {/* --------- mobile-menu ------ */}
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full h-full' : 'h-0 w-0'} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all duration-300 z-50`}>
